...
export class ResourceSettingsServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this
      .constructor as typeof ResourceSettingsServiceClient;
    const servicePath =
    ...
    this.descriptors.page = {
      listSettings: new this._gaxModule.PageDescriptor(
        'pageToken',
        'nextPageToken',
        'settings'
      ),
    ...
    this.resourceSettingsServiceStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.resourcesettings.v1
  ...
  matchFolderFromFolderSettingNameName(folderSettingNameName: string) {
    return this.pathTemplates.folderSettingNamePathTemplate.match(
   ...
   */
  matchOrganizationFromOrganizationSettingNameName(
    organizationSettingNameName: string
  ) {
    return this.pathTemplates.organizationSettingNamePathTemplate.match(
   ...
   * @returns {string} A string representing the setting_name.
   */
  matchSettingNameFromOrganizationSettingNameName(
    organizationSettingNameName: string
  ) {
    return this.pathTemplates.organizationSettingNamePathTemplate.match(
      organizationSettingNameName
   ...
   */
  matchProjectNumberFromProjectNumberSettingNameName(
    projectNumberSettingNameName: string
  ) {
    return this.pathTemplates.projectNumberSettingNamePathTemplate.match(
   ...
   * @returns {string} A string representing the setting_name.
   */
  matchSettingNameFromProjectNumberSettingNameName(
    projectNumberSettingNameName: string
  ) {
    return this.pathTemplates.projectNumberSettingNamePathTemplate.match(
      projectNumberSettingNameName
