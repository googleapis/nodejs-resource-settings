 ...
 * `src/v1/resource_settings_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './resource_settings_service_client_config.json';
...
export class ResourceSettingsServiceClient {
  ...
  resourceSettingsServiceStub?: Promise<{[name: string]: Function}>;
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof ResourceSettingsServiceClient;
    ...
    this.pathTemplates = {
      folderSettingNamePathTemplate: new this._gaxModule.PathTemplate(
        'folders/{folder}/settings/{setting_name}'
      ),
      organizationSettingNamePathTemplate: new this._gaxModule.PathTemplate(
        'organizations/{organization}/settings/{setting_name}'
      ),
      projectNumberSettingNamePathTemplate: new this._gaxModule.PathTemplate(
    ...
    this.descriptors.page = {
      listSettings:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'settings')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.resourcesettings.v1.ResourceSettingsService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.resourceSettingsServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.resourcesettings.v1.ResourceSettingsService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.resourcesettings.v1.ResourceSettingsService,
        this._opts, this._providedCustomServicePath) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const resourceSettingsServiceStubMethods =
        ['listSettings', 'getSetting', 'updateSetting'];
    for (const methodName of resourceSettingsServiceStubMethods) {
      const callPromise = this.resourceSettingsServiceStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  static get servicePath() {
    return 'resourcesettings.googleapis.com';
  }
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Setting]{@link google.cloud.resourcesettings.v1.Setting}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Setting]{@link google.cloud.resourcesettings.v1.Setting} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Setting]{@link google.cloud.resourcesettings.v1.Setting}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listSettingsAsync(
    ...
    return this.descriptors.page.listSettings.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.cloud.resourcesettings.v1.ISetting>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
   ...
   */
  folderSettingNamePath(folder:string,settingName:string) {
    return this.pathTemplates.folderSettingNamePathTemplate.render({
      folder: folder,
   ...
   *
   * @param {string} folderSettingNameName
   *   A fully-qualified path representing folder_setting_name resource.
   * @returns {string} A string representing the folder.
   */
  matchFolderFromFolderSettingNameName(folderSettingNameName: string) {
    return this.pathTemplates.folderSettingNamePathTemplate.match(folderSettingNameName).folder;
  }
   ...
   * @param {string} folderSettingNameName
   *   A fully-qualified path representing folder_setting_name resource.
   * @returns {string} A string representing the setting_name.
   */
  matchSettingNameFromFolderSettingNameName(folderSettingNameName: string) {
    return this.pathTemplates.folderSettingNamePathTemplate.match(folderSettingNameName).setting_name;
  }
   ...
   * @returns {string} Resource name string.
   */
  organizationSettingNamePath(organization:string,settingName:string) {
    return this.pathTemplates.organizationSettingNamePathTemplate.render({
   ...
   *
   * @param {string} organizationSettingNameName
   *   A fully-qualified path representing organization_setting_name resource.
   * @returns {string} A string representing the organization.
   */
  matchOrganizationFromOrganizationSettingNameName(organizationSettingNameName: string) {
    return this.pathTemplates.organizationSettingNamePathTemplate.match(organizationSettingNameName).organization;
  }
   ...
   * @returns {string} A string representing the setting_name.
   */
  matchSettingNameFromOrganizationSettingNameName(organizationSettingNameName: string) {
    return this.pathTemplates.organizationSettingNamePathTemplate.match(organizationSettingNameName).setting_name;
  }
   ...
   * @returns {string} Resource name string.
   */
  projectNumberSettingNamePath(projectNumber:string,settingName:string) {
    return this.pathTemplates.projectNumberSettingNamePathTemplate.render({
   ...
   *
   * @param {string} projectNumberSettingNameName
   ...
   */
  matchProjectNumberFromProjectNumberSettingNameName(projectNumberSettingNameName: string) {
    return this.pathTemplates.projectNumberSettingNamePathTemplate.match(projectNumberSettingNameName).project_number;
  }
   ...
   * @returns {string} A string representing the setting_name.
   */
  matchSettingNameFromProjectNumberSettingNameName(projectNumberSettingNameName: string) {
    return this.pathTemplates.projectNumberSettingNamePathTemplate.match(projectNumberSettingNameName).setting_name;
  }
